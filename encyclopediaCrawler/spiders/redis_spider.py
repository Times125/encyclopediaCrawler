...
__all__ = ['RedisCrawlSpider', 'RedisSpider']


class RedisMixin(object):
    """Mixin class to implement reading urls from a redis queue."""
    task_queue = None
    use_set = spider_args['use_set']
    redis_encoding = 'utf8'
    redis_con = None
    redis_batch_size = spider_args['spider_feed_size']
    ...
    def next_requests(self):
        ...
        if found:
            self.logger.debug("Read %s requests from '%s'", found, self.task_queue)
